...
Dies ist nicht nur zur Darstellung von Buttons, also der Implementierung von Interaktionen nötig, sondern auch zur beispielsweise korrekten Anzeige von aktuell ausgewählten Regionen.
...
imports
allgemeine Anwendung (main, init, subcritpions)
type Model + Msg
update
filterGenre
Buttons
