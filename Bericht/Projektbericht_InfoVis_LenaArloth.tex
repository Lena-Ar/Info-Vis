...
%korrelationen zwischen 2 regionen im detail (SPort: Nordamerika, Europa -> Cluster + keine Korrelation + positive (leicht)), (action: alle in allen Kombis kurz, positive korrelation, ausßreiser, cluster, japan)
%bezug bei sport auf Ursürugnsland von 505 Games, weil natürlicherweise da eher fokus drauf 
%vergleich wo mein spiel schon liegt -> entscheidung evtl fortsetzung?
%Fazit: 
