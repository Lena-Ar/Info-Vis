...
%Mit Klick auf den Link in der Navigation gelangen die Betrachter zu den detaillierteren Visualisierungen.
...
%hier nochmal erklärung anschauen ob korrekt
...
%Der durch Hovern zu identifizierende Ausreißer sollte bei Entscheidung für \textit{Action} genauer untersucht werden.
...
%, dass einige Spiele in Nordamerika besser verkauft werden als in Europa, im Rest der Welt und global jedoch wieder ähnlich, wenn auch etwas schlechter als in Nordamerika. 
...
%Je besser sich Videospiele in Nordamerika/Eurpa verkaufen hat keine Einfluss auf die Verkaufszahlen in der je anderen Region.
...
%Bild Sports
%Während bei einigen Spielen zwischen beiden Regionen ein deutlich positiv korreliertes Cluster sichtbar ist, 
%scheinen die anderen Spiele ein Cluster ohne Korrelation zwischen den Regionen zu bilden.
...
%Zuletzt werden die Erkenntnisse im Genre \textit{Action} überprüft, sodass die Filterung angepasst wird. 
%Durch Belegung der Achsen in allen Kombinationen, außer jenen mit Japan, 
%bestätigt sich deutlich die leicht bis vollständig positive Korrelation zwischen den jeweiligen Verkaufszahlen der Regionen sowie der Ausreißer.
%Auch die nicht vorhandene Abhängigkeit zwischen den Regionen und Japan zeigt sich deutlich.
%Einzelnen Datenpunkte sind im Scatterplot jedoch besser erkenn- und zur näheren Betrachtung auswählbar. 
%Sollte der Wunsch nach paralleler Betrachtung des Baumdiagramms aufkommen, 
%so kann dieser durch den Link am jeweiligen Seitenende in einem neuen Fenster geöffnet werden.
...
%Japan komplett unfokussiert weil viele Null-Werte oder eben sehr kleine Verkaufsmengen und keine Korrelationen
%Es besteht jedoch die Möglichkeit, dass der Absatz in Japan schlicht zu gering ist, um hier gezählt zu werden.
...
%Korrelationen zwischen zwei gewählten Regionen sowie Ausreißer und die Bildung von Clustern konnten somit detaillierter dargestellt und analysiert werden.
